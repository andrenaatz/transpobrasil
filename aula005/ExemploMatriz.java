...
public class ExemploMatriz {
	...
	public static void main(String[] args){
		...
		regioes[0] = new String[3]; // arrays numa matriz nao precisa ser todos do mesmo tamanho
		...
		String[][] disciplinas = new String[][]{{"Lógica","Banco de Dados","Java Fundamentos"},{"HTML","CSS","Javascript Básico"},{"Angular 1","Angular 6",
			"React","Vuejs"}};
